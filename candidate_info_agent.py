...
class Candidate(BaseModel):
    ...
    technologies: List[str] = Field(default_factory=list, description="List of known technologies or programming languages")
    tools: List[str] = Field(default_factory=list, description="List of tools, frameworks, or platforms the candidate has used")
